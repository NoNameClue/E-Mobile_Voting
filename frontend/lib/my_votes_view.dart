...
class _MyVotesViewState extends State<MyVotesView> {
  ...
  Map<String, dynamic> _candidateStats =
      {}; // Stores live votes/percentages keyed by candidate name
  ...
  Future<void> loadVotes() async {
    try {
      ...
      if (selectedPoll != null) {
        ...
        if (selectedPoll!['candidates'] != null &&
            selectedPoll!['candidates'].isNotEmpty) {
  ...
  void _onPollChanged(Map<String, dynamic>? newPoll) async {
    ...
    setState(() {
      ...
      _displayingCandidate =
          newPoll['candidates'] != null && newPoll['candidates'].isNotEmpty
              ...
              Expanded(
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final isDisplaying =
                        _displayingCandidate?['name'] == candidate['name'];
                          ...
                          children: [
                            CircleAvatar(
                              ...
                              backgroundImage: candidate["photo"] != null
                                  ? NetworkImage(
                                      '${ApiConfig.baseUrl}/${candidate["photo"]}',
                                    )
                                  : null,
  ...
  Widget _buildDetailPanel() {
    if (_displayingCandidate == null) {
      return Container(
        ...
        child: const Center(
          child: Text(
            "Select a candidate to view stats.",
    ...
    final stats =
        _candidateStats[candidateName] ?? {'votes': 0, 'percentage': 0.0};
        ...
        child: Column(
          ...
          children: [
            CircleAvatar(
              ...
              backgroundColor: Colors.grey[300],
              backgroundImage: candidate["photo"] != null
                  ? NetworkImage('${ApiConfig.baseUrl}/${candidate["photo"]}')
                  : null,
              child: candidate["photo"] == null
