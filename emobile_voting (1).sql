...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 03, 2026 at 01:50 PM
...
ALTER TABLE `candidates`
  ...
  ADD KEY `fk_candidates_poll` (`poll_id`);
...
--
ALTER TABLE `candidates`
  ADD CONSTRAINT `fk_candidates_poll` FOREIGN KEY (`poll_id`) REFERENCES `polls` (`poll_id`) ON DELETE CASCADE;

--
-- Constraints for table `votes`
--
ALTER TABLE `votes`
  ADD CONSTRAINT `fk_votes_candidate` FOREIGN KEY (`candidate_id`) REFERENCES `candidates` (`candidate_id`) ON DELETE CASCADE,
